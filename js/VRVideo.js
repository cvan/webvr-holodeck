...
(function () {
  ...
  var extRegex = /\.(webm|ogg|ogv|m4v|mp4|mov)/i;
  ...
  var video = function (parent, options) {
    ...
    function loadedMetadata() {
      //todo: don't do any of self if object has been deleted
    ...
    function setSource(sources) {
      sources.forEach(function (src) {
        ...
        if (parse && parse.origin !== window.location.origin) {
    ...
    /*
    Pause the video when self browser tab is in the background or minimized.
